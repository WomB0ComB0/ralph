...
| `org-soak-summary --org ORG [--json]` | Summarize org-patrol `soak-summary.jsonl` into cycle counts, failure counts, worst elapsed time, last resource band, and recent Synapse rc values |
